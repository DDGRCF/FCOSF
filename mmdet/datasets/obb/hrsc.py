...
class HRSCDataset(CustomDataset):
    ...
    def __init__(self, imgset, ann_file, img_prefix, *args, **kwargs):
        self.imgset = imgset
        super(HRSCDataset, self).__init__(
            *args, ann_file=ann_file, img_prefix=img_prefix, **kwargs)
    ...
    def load_annotations(self, ann_file):
        contents, _ = bt.load_hrsc(
            img_dir=self.img_prefix, ann_dir=ann_file, classes=self.CLASSES)
